...
createMonsterForm=()=>{const a=document.createElement('form'),
    b=document.createElement('input'),c=document.createElement('input'),
    d=document.createElement('input'),e=document.createElement('button');
        ...
        postNewMonster=a=>{
            let b=URL_PREFIX+`monsters`,
                c={method:'POST',
                    ...
                    Accept:'application/json'},body:JSON.stringify(a)};
